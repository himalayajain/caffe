...
BRANCHES=('resize' 'fast_hdf5' 'transform_layer' 'transforming_fast_hdf5' 'array' 'net_from_string' 'color_conv' 'wait_for_cuda' 'repack' 'python_util' 'openmp' 'import_fix' 'make_future')
echo "***************************************************************** "
